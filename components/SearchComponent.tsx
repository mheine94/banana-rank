...
export default function SearchComponent({ onSearch, leaderBoard } : SearchComponentProps) {
...
const styles = StyleSheet.create({
    container : {
        flexDirection: "row", alignItems: "center", paddingHorizontal: 10, paddingBottom: 5
    },
    searchbar: { 
